...
Now compare the `Rcpp` version with the `R` version on a relative scale. We can see that the `Rcpp` version is about $50\%$ faster on average.
...
```{r}
sourceCpp("mean_var_KRS_Rcpp.cpp")
cpp_result = mean_var_KRS_Rcpp(y, x, xseq, 0.06)
